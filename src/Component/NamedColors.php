...
class NamedColors
{
    ...
    {
        return isset(self::$colors[$name]);
    }

    /**
     * @param string $name
     * @return array like [red, green, blue]
     * @throws InvalidNamedColorException
     */
    public static function get($name)
    {
        if (!self::exists($name)) {
            throw new InvalidNamedColorException($name . ' is not a valid named color');
        }
